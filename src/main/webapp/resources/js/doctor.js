...
//        const doctorEndpoint = doctorEndpoint;
//        console
        ...
        fetch(endpoint, {
                ...
                showCertificate.innerHTML = `<h1 class="text-danger">Phieu kham</h1>
                        <div class="container mt-3">   
                                ...
                                <button class="btn btn-info" onclick="createPrescription('${doctorEndpoint}', ${certificate.id}, '${currentUser}')">Tạo toa thuốc</button>
...
function createPrescription(doctorEndpoint, certificateID, currentUser) {
        ...
        fetch(createPrescriptionEndpoint, {
                ...
                prescriptionEle.innerHTML = `
                        <div>
                                <h1>Toa thuoc ${++count}</h1>
                                <table class="table table-striped">
                                        <thead>
                                                <tr>
                                                        <th>MA TOA THUOC</th>
                        ...
                        <div>       
                                <table class="table">
                                        ...
                                        <tbody id="medicineInPrescription">
...
function addMedicine(doctorEndpoint, prescriptionID, medicineID) {
        ...
        const medicineInPrescriptionEle = document.getElementById('medicineInPrescription');
