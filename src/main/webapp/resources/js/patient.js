                        ...
                        certificatesList.forEach(certificates => {
                                certificates.forEach(certificate => {
                                        ...
                                        <div class="container mt-3 " id="certificateNode-${certificate.id}">   
                                                ...
                                                <button id="certificateBtn-${certificate.id}" class="btn btn-success" onclick="handlePrescription('${endpoint}', ${certificate.id})">Xem toa thuốc</button>
                                         </div>
`
                                        medicalHistoryElement.appendChild(certificateNode);
                                });
...
function handlePrescription(endpoint, certificateID) {
                        ...
                        prescriptions.forEach(prescription => {
                                ...
                                htmls += `
                                        ...
                                        <div  class="container mt-3" >   
                                                ...
                                                <button class="btn btn-success" onclick="handlePrescriptionDetail('${endpoint}', ${prescription.id})">Xem chi tiết</button>
                                        </div>
`
                                count++;
                        });
...
function handlePrescriptionDetail(endpoint, prescriptionID) {
        ...
        fetch(getPrescriptionDetailEnpoint)
                ...
                .then(presciptionDetails => {
                        console.log(prescriptionNode);
                        console.log(presciptionDetails)
                        let htmls =
